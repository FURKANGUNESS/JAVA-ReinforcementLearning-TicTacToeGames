...
public class Vec implements Serializable {
    ...
    /**
     * @param double array v
     *               Gelen arraye gore vektor yaratir.
     */
    public Vec(double[] v) {
    ...
    /**
     * @param rhs Disaridan gelen vektoru ice kopyalar.
     */
    ...
    /**
     * @param i
     * @param value Vektoru gelen indekse gore deger atar.
     */
    ...
    /**
     * @param rhs
     * @return vektorlerin esitligini kontrol eder.
     */
    @Override
    ...
    /**
     * @param value Tum indekslere value degerini atar.
     */
    ...
    /**
     * @param indices
     * @return En yuksek degerli indeksi getirir.
     */
    ...
    /**
     * @param rhs
     * @return Gelen rhs ile vektoru carpiyor.
     */
    ...
    /**
     * @param scalar
     * @return Vektorun skaler kadar karesini alir.
     */
    ...
    /**
     * @param rhs
     * @return Vektorun toplamini alir.
     */
    ...
    /**
     * @return Matrisi normalize ediyorum.
     */
