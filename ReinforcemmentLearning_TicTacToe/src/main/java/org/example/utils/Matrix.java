...
public class Matrix implements Serializable {
    ...
    /**
     * @param A AxA bir matris yaratir.
     */
    ...
    /**
     * @param rhs
     * @return Objenin esitligini kontrol ediyor.
     */
    @Override
    ...
    /**
     * @return Matrisin kopyasini yaratir.
     */
    ...
    /**
     * @param rhs parametreden gelen matrisi ice kopyalar.
     */
     ...
     * @param rowIndex
     * @param columnIndex
     * @param value       Matrisin bir hucresinin degeri set edilir.
     */
    ...
    /**
     * @param rowCount
     * @param columnCount row ve column gore matris yaratir.
     */
    ...
    /**
     * @param value Gelen deger tum hucrelere atanir.
     */
     ...
     * @param rowIndex
     * @param columnIndex
     * @return Koordinatlara gore hucrenin degeri cekilir.
     */
    ...
    /**
     * @return Var olan matris kolonlari liste halinde geri dondurur.
     */
    ...
    public Matrix multiply(Matrix rhs) {
        if (this.getColumnCount() != rhs.getRowCount()) {
            System.err.println("1.Matrisin kolon sayisi ile 2.Matrisin satir sayisi esit olmalidir.");
            return null;
        }
    ...
    /**
     * @return Simetrik mi diye bakiyor.
     */
    ...
    /**
     * @param rhs
     * @return Matris ile bir vektorun carpimidir.
     */
    public Vec multiply(Vec rhs) {
        if (this.getColumnCount() != rhs.getDimension()) {
            System.err.println("Matrisin kolon sayisi Vektorun uzunluguna esit olmalidir.");
        }
