...
/**
 * @author furkangunes
 * Q-öğrenme algoritmasını kullanan bir agent sınıfıdır.
 */
public class QAgent implements Serializable {
    ...
    /**
     * @return Önceki durumda alınan aksiyonu döndürür.
     */
    ...
    /**
     * @return Bu QAgent nesnesinin bir kopyasını oluşturur.
     */
