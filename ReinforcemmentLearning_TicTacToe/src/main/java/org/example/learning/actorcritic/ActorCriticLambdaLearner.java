...
/**
 * @author furkangunes
 * actorCriticLambdaLearner sınıfı actorCriticLearner sınıfının bir türevidir ve actor-critic öğrenme yöntemini kullanan bir öğrenme algoritmasını temsil etmektedir.
 */
